...
public class CalculadoraBasica {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("S = SUMA || R = RESTA || D = DIVISION || M = MULTIPLICACION || P = PORCENTAJE ");
        entrada.nextLine();
        ...
        switch (res){
            case 'S':
                total= num1 + num2;
                System.out.printf("La suma de %d + %d es: %d",num1,num2,total);
                break;
            case 'R':
                total= num1 - num2;
                System.out.printf("La resta de %d - %d es: %d",num1,num2,total);
                break; 
            case 'D':
                
                if(num2!=0){
                
                    totalD = num1 / (double)num2;
                    System.out.printf("La division de %d / %d es: %.2f",num1,num2,totalD);
            ...
            case 'M':
                total= num1 * num2;
                System.out.printf("La multiplicacion de %d * %d es: %d",num1,num2,total);
                break; 
            case 'P':
                porce = (double)num2 / 100;
                totalP = num1 * porce;
                System.out.printf("El primer numero que ingreso es %d el porcentaje que desea sacar es %dxciento el total es %.2f",num1,num2,totalP);
